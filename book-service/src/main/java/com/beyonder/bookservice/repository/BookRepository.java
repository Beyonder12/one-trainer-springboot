...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    // Derivative Query can use suggest combination properties by idea
    List<Book> findBooksByAuthorAndTitleContaining(@Param("author") String author, @Param("title") String title);
